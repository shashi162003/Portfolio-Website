...
const BlogPost = () => {
    ...
    const [loadingComment, setLoadingComment] = useState(false); useEffect(() => {
        fetchBlog();
    }, [id]);
        ...
        <div className="min-h-screen bg-primary pt-24 pb-12 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    Back to Blogs
                </button>                <article className="bg-tertiary rounded-lg overflow-hidden">
                ...
                </article>                <div className="mt-8 flex items-center gap-4">
                    <button
                        onClick={handleLike}
                        disabled={loadingLike}
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors text-white ${liked ? 'bg-red-500 hover:bg-red-600' : 'bg-tertiary hover:bg-tertiary/80'
                ...
                <div className="mt-12">
                    ...
                    <form onSubmit={handleComment} className="mb-8">                        <textarea
                        value={comment}
                        onChange={(e) => {
                    ...
                    <div className="space-y-6">
                        {blog.comments.map((comment) => (
                            <div key={comment._id} className="bg-tertiary rounded-lg p-6">                                <div className="flex items-center gap-4">
                                {comment.author && (
                                    <>
                                        <img
